...
BoxArenaRootPath=/home/yusuf/Documents/Unreal Projects/BoxArena
...
include(BoxArenaSource.pri)
include(BoxArenaHeader.pri)
include(BoxArenaConfig.pri)
include(BoxArenaIncludes.pri)
include(BoxArenaDefines.pri)

BoxArena-Linux-Debug.commands = $$build BoxArena Linux Debug  -project="\"$$gameProjectFile\"" $$args
BoxArena-Linux-DebugGame.commands = $$build BoxArena Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BoxArena-Linux-Shipping.commands = $$build BoxArena Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BoxArena-Linux-Test.commands = $$build BoxArena Linux Test  -project="\"$$gameProjectFile\"" $$args
BoxArena.commands = $$build BoxArena Linux Development  -project="\"$$gameProjectFile\"" $$args

BoxArenaEditor-Linux-Debug.commands = $$build BoxArenaEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BoxArenaEditor-Linux-DebugGame.commands = $$build BoxArenaEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BoxArenaEditor-Linux-Shipping.commands = $$build BoxArenaEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BoxArenaEditor-Linux-Test.commands = $$build BoxArenaEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BoxArenaEditor.commands = $$build BoxArenaEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
