...
CubeArenaRootPath=/home/yusuf/Documents/Unreal Projects/CubeArena
...
include(CubeArenaSource.pri)
include(CubeArenaHeader.pri)
include(CubeArenaConfig.pri)
include(CubeArenaIncludes.pri)
include(CubeArenaDefines.pri)

CubeArena-Linux-Debug.commands = $$build CubeArena Linux Debug  -project="\"$$gameProjectFile\"" $$args
CubeArena-Linux-DebugGame.commands = $$build CubeArena Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CubeArena-Linux-Shipping.commands = $$build CubeArena Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CubeArena-Linux-Test.commands = $$build CubeArena Linux Test  -project="\"$$gameProjectFile\"" $$args
CubeArena.commands = $$build CubeArena Linux Development  -project="\"$$gameProjectFile\"" $$args

CubeArenaEditor-Linux-Debug.commands = $$build CubeArenaEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
CubeArenaEditor-Linux-DebugGame.commands = $$build CubeArenaEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CubeArenaEditor-Linux-Shipping.commands = $$build CubeArenaEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CubeArenaEditor-Linux-Test.commands = $$build CubeArenaEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
CubeArenaEditor.commands = $$build CubeArenaEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
